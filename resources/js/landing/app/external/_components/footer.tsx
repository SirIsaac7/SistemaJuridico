  ...
  return (
    <footer className="relative overflow-hidden bg-[linear-gradient(180deg,#2e1065_0%,#241056_55%,#1e1b4b_100%)] pt-16 pb-10 sm:pt-20">
      ...
      <div
        ...
        aria-hidden
      >
        <span className="lj-font-heading translate-y-6 font-black text-[22vw] text-white/4 uppercase leading-none tracking-tighter">
          Normativa
        </span>
      </div>
      ...
      <div className="lj-container relative z-10">
        ...
        <div className="mb-14 grid grid-cols-1 gap-12 lg:mb-20 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="mb-8 max-w-xs text-sm text-white/65 leading-relaxed">
              Empresa internacional de normativa actualizada para el ámbito empresarial y gubernamental, con cobertura
              en nueve países de Iberoamérica.
            </p>
            ...
            <div>
              ...
              <div className="flex">
                <input
                  ...
                  className="flex-1 rounded-l-full border border-white/15 border-r-0 bg-white/10 px-5 py-3 text-sm text-white backdrop-blur-sm placeholder:text-white/45 focus:border-[#a5f3fc]/60 focus:outline-none"
                />
                <button
                  type="button"
                  aria-label="Suscribirse al boletín"
                  onClick={() => toast.success("¡Gracias por suscribirse! Pronto recibirá nuestras novedades.")}
                  className="rounded-r-full bg-[linear-gradient(100deg,#6366f1_0%,#7c3aed_100%)] px-5 py-3 font-bold text-sm text-white transition-shadow hover:shadow-[0_10px_26px_-8px_rgba(124,58,237,0.9)]"
                >
        ...
        <div className="flex flex-col items-center justify-between gap-6 border-white/10 border-t pt-8 md:flex-row">
          <p className="text-white/50 text-xs">
            © {new Date().getFullYear()} Normativa Virtual. Todos los derechos reservados.
          </p>
          ...
          <p className="text-white/50 text-xs">Privacidad · Términos · Cookies</p>
        </div>
      </div>
    </footer>
  );
