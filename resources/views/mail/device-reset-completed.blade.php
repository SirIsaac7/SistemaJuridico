                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="width: 100%; max-width: 600px; overflow: hidden; background-color: #ffffff; border: 1px solid #e5eaf0; border-radius: 14px; box-shadow: 0 8px 28px rgba(30, 42, 74, 0.08);">
                    ...
                    <tr>
                        <td style="padding: 38px 32px 18px;">
                            <div style="margin-bottom: 18px; color: #1e2a4a; font-family: Georgia, 'Times New Roman', serif; font-size: 27px; font-weight: 700; line-height: 1.25;">Dispositivo restablecido</div>
                            <p style="margin: 0 0 18px; color: #2a3547; font-size: 16px; line-height: 1.65;">Hola, <strong>{{ $name }}</strong>:</p>
                            <p style="margin: 0 0 22px; color: #526178; font-size: 15px; line-height: 1.7;">El dispositivo vinculado a tu cuenta fue restablecido correctamente.</p>

                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom: 28px; background-color: #f7f3e5; border-left: 4px solid #d4af37; border-radius: 6px;">
                                <tr>
                                    <td style="padding: 17px 18px; color: #2a3547; font-size: 15px; font-weight: 600; line-height: 1.6;">Ya puedes iniciar sesión desde otro dispositivo y navegador.</td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: 0 auto 30px;">
                                <tr>
                                    <td align="center" bgcolor="#1e2a4a" style="border-radius: 7px;">
                                        <a href="{{ $loginUrl }}" style="display: inline-block; padding: 14px 28px; color: #ffffff; font-size: 15px; font-weight: 700; text-decoration: none;">Iniciar sesión</a>
                                    </td>
                                </tr>
                            </table>

                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-top: 1px solid #e5eaf0;">
                                <tr>
                                    <td style="padding-top: 22px; color: #6b778c; font-size: 13px; line-height: 1.65;">
                                        <strong style="color: #526178;">¿No solicitaste este cambio?</strong><br>
                    ...
                    <tr>
                        <td style="padding: 18px 32px 34px;">
                            ...
                            <p style="margin: 5px 0 0; word-break: break-all; font-size: 12px; line-height: 1.6;"><a href="{{ $loginUrl }}" style="color: #8a6a16; text-decoration: underline;">{{ $loginUrl }}</a></p>
                        </td>
                    </tr>
                </table>
